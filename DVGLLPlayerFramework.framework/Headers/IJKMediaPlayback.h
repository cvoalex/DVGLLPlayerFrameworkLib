...
- (long)doAccurateSeekSkip:(double)skipToTargetPts ptsCorrection:(double)targetPtsCorrection;
- (long)setAccurateBufferingSec:(double)streamBuffsec fps:(double)streamFps;
- (double)getOnScreenPtsV;// Non-real, can be corrected!
- (double)getOnScreenPtsA;// Non-real, can be corrected!
- (double)getOnDecoPtsV;
- (double)getOnDecoPtsA;
- (double)getOnPaktPtsV;
- (double)getOnPaktPtsA;
- (double)getTimestamp;
- (int)fillStat:(int*)stats;
